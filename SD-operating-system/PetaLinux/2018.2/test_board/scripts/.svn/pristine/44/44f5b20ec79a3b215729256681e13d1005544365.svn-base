        ...
        if {$id ne "ID" } {
          ...
          if {$rundesign == true} {
            ...
            for {set i 0} {$i < [llength $TE::TE_INTERNAL_EXPORT]} {incr i} {
              ...
              if {[catch {TE::UTILS::copy_prod_export $export_typ $export_app} result]} {abort_status "Error Initialisation..."; create_allboardfiles_status; TE::UTILS::te_msg TE_INIT-171 ERROR "Script (TE::UTILS::copy_prod_export) failed: $result."; return -code error}
            }
